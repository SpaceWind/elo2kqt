...
void RenderManager::init()
{
    ...
    parallaxConfig p("../elo2kqtEngine/data/config.txt","parallax_default");
    ...
    QString filename = "../elo2kqtEngine/data/fx/sf.txt";
...
void RenderManager::render(QPainter *painter, QPaintEvent *event)
{
